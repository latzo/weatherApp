...
class CityResourceIT {
    ...
    public static City createEntity(EntityManager em) {
        City city = new City().name(DEFAULT_NAME).lat(DEFAULT_LAT).lng(DEFAULT_LNG);
        return city;
    }
    ...
    public static City createUpdatedEntity(EntityManager em) {
        City city = new City().name(UPDATED_NAME).lat(UPDATED_LAT).lng(UPDATED_LNG);
        return city;
    }
    ...
    void putExistingCity() throws Exception {
        ...
        updatedCity.name(UPDATED_NAME).lat(UPDATED_LAT).lng(UPDATED_LNG);
    ...
    void fullUpdateCityWithPatch() throws Exception {
        ...
        partialUpdatedCity.name(UPDATED_NAME).lat(UPDATED_LAT).lng(UPDATED_LNG);
